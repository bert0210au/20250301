...
public class ProductJpaServiceImpl implements ProductService {
	...
	public void addProduct(ProductVo vo) {
		...
		// 新增 ProductPrice 資料
		ProductPriceEntity produtPriceEntity = new ProductPriceEntity();
		produtPriceEntity.setListPrice(vo.getListPrice());
		produtPriceEntity.setSalesPrice(vo.getSalesPrice());
		//produtPriceEntity.setProductId(entity.getId());
		productPriceRepository.save(produtPriceEntity);
